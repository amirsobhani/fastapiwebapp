...
def do_user_import(user_lookup: Dict[str, str]) -> Dict[str, User]:
    ...
    # with progressbar.ProgressBar(maxval=len(user_lookup)) as bar:
...
def do_import_packages(file_data: List[dict], user_lookup: Dict[str, User]):
    ...
    # with progressbar.ProgressBar(maxval=len(file_data)) as bar:
...
def find_users(data: List[dict]) -> dict:
    ...
    # with progressbar.ProgressBar(maxval=len(data)) as bar:
